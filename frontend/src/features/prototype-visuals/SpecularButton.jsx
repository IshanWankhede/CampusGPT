...
function SpecularButton({
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      style: cssVars,
      children: [
        /* @__PURE__ */ jsx("span", { ref: fxRef, "aria-hidden": "true", className: "pointer-events-none absolute -inset-5 z-[1] [&_canvas]:block [&_canvas]:h-full [&_canvas]:w-full" }),
        /* @__PURE__ */ jsx("span", { className: "relative z-[2] flex items-center justify-center gap-2", children })
      ]
    }
  );
}
export {
  SpecularButton as default
};
